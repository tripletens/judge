...
<body>
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <!-- https://cdn.pixabay.com/photo/2017/06/27/09/21/handarbeiten-2446806_960_720.jpg -->
                <img src="img/01.jpg" height="700px" width="1200px" alt="" />
            </div>
             <div class="carousel-item">
                <!-- https://cdn.pixabay.com/photo/2015/03/17/22/51/still-life-678473_960_720.jpg -->
                <img src="img/25.jpg" height="700px" width="1200px" alt="" />
            </div>
            <div class="carousel-item active">
                <!-- https://cdn.pixabay.com/photo/2016/03/01/04/47/sewing-1229711_960_720.jpg -->
                 <img src="" height="700px" width="1200px" alt="" />
    ...
    <!-- <img src="https://cdn.pixabay.com/photo/2017/06/27/09/21/handarbeiten-2446806_960_720.jpg" width="1200px" alt="" /> -->
    ...
    <div class="container">
        <div class="row">
            <div class="content">
                <div class="grid">
                    <figure class="effect-zoe">
                        <img src="../assets/img/30.jpg" alt="img25" />
                        <figcaption>
                    ...
                    <figure class="effect-zoe">
                        <img src="../assets/img/27.jpg" alt="img26" />
                        <figcaption>
                            <h2>Title <span>Name</span></h2>
                            <p class="icon-links">
                                <a href="#"><span class="icon-heart"></span></a>
            ...
            <div class="content">
                <div class="grid">
                    <figure class="effect-zoe">
                        <img src="../assets/img/25.jpg" alt="img27" />
                        <figcaption>
                            <h2>Title <span>Name</span></h2>
                            <p class="icon-links">
                                <a href="#"><span class="icon-heart"></span></a>
                    ...
                    <figure class="effect-zoe">
                        <img src="../assets/img/26.jpg" alt="img30" />
                        <figcaption>
                            <h2>Title <span>Name</span></h2>
                            <p class="icon-links">
                                <a href="#"><span class="icon-heart"></span></a>
    ...
    <footer>
        <div class="last-div">
            <div class="container">
                <div class="row">
                    <div class="copyright">
                        &copy; Flashion All Rights Reserved
                    </div>
                </div>
            </div>
            <div class="container">
