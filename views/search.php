...
<!--                 <label for="pwd">Password:</label>
 -->                <input type="password" class="form-control" placeholder="Enter Password"  name="password" id="pwd">
              ...
              <button type="submit" class="btn btn-default w3-red" name="submit">Submit</button>
            </form>
                      ...
                      while($row_result = mysqli_fetch_assoc($catalog_result)) {
                        echo "<div class='w3-container w3-col l3 s12'>
                            <div class='w3-display-container'>
                              <img src='img/". $row_result['image_name'].".jpg' style='width:100%''>
                           <span class='w3-tag w3-display-topleft'>" .$row_result['status']."</span>
                              <div class='w3-display-middle w3-display-hover'>
                                <button class='w3-button buy' ><a href='login.php'>Buy now <i class='fa fa-shopping-cart'></i></a></button>
